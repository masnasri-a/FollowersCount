...
headers = {
    ...
    # 'refe/rer': 'https://twitter.com/FiersaBesari/status/1313990655698329600',
...
result = response.json()['data']['tweetResult']['result']['legacy']
temp = {
    "tweet":result['full_text'],
    "like":result['favorite_count'],
    "quote":result['quote_count'],
